...
= 2.19.0 =
[ Add Function ][ Taxonomy Search Pro ] Support exclude taxonomy queries ( category / tag / taxonomy )
[ Specific Change ][ Taxonomy Search Pro ] Reversed screen size order for checkbox/radio button columns.
